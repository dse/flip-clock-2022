...
var app = {
  ...
  keepAwake: function keepAwake() {
    var _window$plugins;
    if (!((_window$plugins = window.plugins) !== null && _window$plugins !== void 0 && _window$plugins.insomnia)) {
      return;
    }
    window.plugins.insomnia.keepAwake();
  },
  allowSleepAgain: function allowSleepAgain() {
    var _window$plugins2;
    if (!((_window$plugins2 = window.plugins) !== null && _window$plugins2 !== void 0 && _window$plugins2.insomnia)) {
      return;
    }
...
/******/ })()
;
//# sourceMappingURL=cordova.bundle.js.map